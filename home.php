	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
	        		<?php
				        ...
				        if(isset($_SESSION['success'])){
				          	echo "
				            	<div class='alert alert-success alert-dismissible noPrint'>
				              		<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				        		...
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										while($crow = $cquery->fetch_assoc()){
											...
											$candidate .= '
												<li>
													'.$input.'<button type="button" class="btn btn-primary btn-sm btn-flat clist platform" data-platform="'.$crow['platform'].'" data-fullname="'.$crow['firstname'].' '.$crow['lastname'].' ('.$crow['course'].'-'.$crow['year'].')"><i class="fa fa-search"></i> Platform</button><img src="'.$image.'" height="100px" width="100px" class="clist"><span class="cname clist"><b>'.$crow['firstname'].' '.$crow['lastname'].'</b><small style="font-size: 1.7rem;"> ('.$crow['course'].'-'.$crow['year'].')</small></span>
												</li>
											';
										}
