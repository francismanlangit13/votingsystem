            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="role" name="role" class="form-control form-control-sm form-control-border select2" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="status" name="status" class="form-control form-control-sm form-control-border select2" required>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="edit_role" name="role" class="form-control form-control-sm form-control-border select2" required>
                      <option value="" disabled selected>Select Role</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="edit_status" name="status" class="form-control form-control-sm form-control-border select2" required>
                      <option value="" disabled selected>Select Status</option>
                      <option value="Active" <?php echo isset($status) && $status == 'Active' ? 'selected' : '' ?>>Active</option>
                      <option value="In active" <?php echo isset($status) && $status == 'In active' ? 'selected' : '' ?>>In active</option>
                    </select>
                  </div>
                </div>
            </div>
